...
if __name__ == "__main__":
    ...
    # Start interrupts
    GPIO.add_event_detect(right_but, GPIO.FALLING, callback = mc.right.move_pend, bouncetime = 200)
    GPIO.add_event_detect(left_but, GPIO.FALLING, callback = mc.left.move_pend, bouncetime = 200)
    GPIO.add_event_detect(up_but, GPIO.FALLING, callback = mc.up.move_pend, bouncetime = 200)
    GPIO.add_event_detect(down_but, GPIO.FALLING, callback = mc.down.move_pend, bouncetime = 200)
    ...
    #GPIO.add_event_detect(lim_x_pos, GPIO.BOTH, callback = mc.check_lim)
    #GPIO.add_event_detect(lim_y_pos, GPIO.BOTH, callback = mc.check_lim)
    #GPIO.add_event_detect(lim_x_neg, GPIO.BOTH, callback = mc.check_lim)
    #GPIO.add_event_detect(lim_y_neg, GPIO.BOTH, callback = mc.check_lim)
